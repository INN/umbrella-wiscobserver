 ...
 *
 * Copied from Largo/partials/content.php shortly after 6ed4f3a, 2016-10-11
 * Difference is that this creates the variable $thumbnail and echoes it, instead of just the_post_thumbnail();
 * $thumbnail allows us to change it if the truth score function returns one.
 *
 * @package Largo
 */
$args = array (
...
<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
	...
	<?php
		...
		if ( $show_thumbnail ) {
			echo '<div class="has-thumbnail '.$hero_class.'"><a href="' . get_permalink() . '">' . $thumbnail  . '</a></div>';
		}
	?>
